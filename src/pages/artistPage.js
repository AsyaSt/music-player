  ...
  <>
    <div className="d-flex justify-content-center flex-column align-items-center">
        <div className="playlist-img-box rounded-circle position-relative"
            style={{backgroundImage: `url(${artist.photo ?? "https://www.pngitem.com/pimgs/m/427-4279206_title-detail-mexican-musician-logo-hd-png-download.png"})`, 
            backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center", width:250, height:250}}
        >
        </div>
        <h1>{artist.name}</h1>
